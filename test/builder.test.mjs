...
eq(us(['Malta, New York', 'Long Island, New York', 'Turkey, Texas', 'Dublin, Ohio', 'Naples, Florida', 'Birmingham, Alabama', 'Rome, New York', 'Providence, Rhode Island, null', 'Rhode Island - Providence', 'Kent Island, MD', "Greece, New York, États-Unis d'Amérique", 'New England US Region', '1910 SE Federal Hwy Stuart, FL']), [], 'a town named like a European country or city is American when a state ends its place');
eq(['Gouda, NL, 2801 SC', 'Madrid, MD, ES, 28050', 'Riga, RI, LV, 1082', 'Balti, MD, 3100', 'Virginia Water, England', 'Washington, Tyne and Wear, GB', 'US or UK Locations', 'US & Ireland', 'USA (Remote) / Barcelona, Spain', 'European Union, Serbia, Georgia', 'Cambridge, Massachusetts or Ex-US Poland'].map(l => placeOf(l, cc).cc), ['nl', 'es', 'lv', 'md', 'gb', 'gb', 'gb', 'ie', 'es', 'rs', 'pl'], 'and the European look-alikes stay in Europe: a Dutch postcode, region codes, a British Washington, and lists that name a European country');
